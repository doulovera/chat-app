    ...
    <div>
      ...
      <form className="mt-10">
        <div>
          ...
          <button
            type="submit"
            className="block w-full text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mt-12 mr-2 mb-2 bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-gray-800"
          >
            Create 💬
          </button>
        </div>
